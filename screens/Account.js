        ...
        <SafeAreaView style = {{flex:1, backgroundColor: 'white'}}>
            <View style = {styles.container}>
                ...
                <View style = {{alignItems: 'flex-end', paddingHorizontal: 10}}>
                        <TouchableOpacity>
                            <Feather name="settings" size={24} color="black" onPress={() => navigation.navigate('Setting')} />
                        </TouchableOpacity>
                    </View>
                    ...
                    <View style = {{marginTop: 20, paddingHorizontal: 10}}>
                        <Text style = {{fontSize: 16, fontWeight: '600', color:'#00CCAA'}}>Active Job Listings</Text>
                    </View>
